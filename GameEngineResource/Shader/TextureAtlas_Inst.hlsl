...
Output TextureAtlas_Inst_VS(Input _input)
{
    ...
    newOutput.pos_ = mul(_input.pos_, allTransformDatas[0].worldViewProjectionMatrix_); //WVP행렬 적용.
...
float4 TextureAtlas_Inst_PS(Output _input) : SV_Target0 //SV_Target[n]: n번 렌더타겟에 결과값을 저장한다.
{
